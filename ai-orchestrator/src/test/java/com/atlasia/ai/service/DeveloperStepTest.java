...
class DeveloperStepTest {
    ...
    void setUp() {
        ...
        when(properties.repoAllowlist()).thenReturn("src/,docs/,pom.xml");
        when(properties.workflowProtectPrefix()).thenReturn(".github/workflows/");
    ...
    void testExecute_createsSuccessfulImplementation() throws Exception {
        ...
        when(gitHubApiClient.getRepoContent(eq("owner"), eq("repo"), anyString()))
                .thenReturn(Map.of("content", Base64.getEncoder().encodeToString("file content".getBytes())));
    ...
    void testExecute_handlesConflictsOnExistingBranch() throws Exception {
        ...
        when(gitHubApiClient.updateReference("owner", "repo", "heads/ai/issue-123", "main-sha-123", true))
                .thenReturn(Map.of("ref", "refs/heads/ai/issue-123"));
    ...
    void testBuildCommitMessage_determinesCorrectIssueType() throws Exception {
        ...
        String commitMessage = invokePrivateMethod(
                "buildCommitMessage",
    ...
    void testMultiFileChanges_createsCorrectTreeStructure() throws Exception {
        ...
        String commitSha = invokePrivateMethod(
                ...
                new Class[]{RunContext.class, String.class, String.class, String.class, String.class, DeveloperStep.CodeChanges.class},
                context,
                "owner",
                "repo",
                "ai/issue-123",
    ...
    void testLlmFallback_createsFallbackImplementation() throws Exception {
        ...
        when(gitHubApiClient.createBranch(anyString(), anyString(), anyString(), anyString()))
                .thenReturn(Map.of("ref", "refs/heads/ai/issue-123"));
        ...
        assertNotNull(result);
        verify(gitHubApiClient).createBlob(eq("owner"), eq("repo"), contains("Implementation Plan"), eq("utf-8"));
    }
