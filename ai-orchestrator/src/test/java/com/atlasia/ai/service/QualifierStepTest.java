...
class QualifierStepTest {
        ...
        void execute_requiresAtLeastThreeTasks() throws Exception {
                ...
                workPlan.put("tasks", List.of(
                                Map.of("id", "task-1", "area", "backend", "description", "Task 1", "filesLikely",
                                                List.of(), "tests", List.of())));
        ...
        void execute_validatesTaskArea() throws Exception {
                ...
                workPlan.put("branchName", "ai/issue-123");
                workPlan.put("tasks", List.of(
                                Map.of("id", "task-1", "area", "invalid", "description", "Task 1", "filesLikely",
                                                List.of(), "tests", List.of()),
                                Map.of("id", "task-2", "area", "backend", "description", "Task 2", "filesLikely",
                                                List.of(), "tests", List.of()),
                                Map.of("id", "task-3", "area", "frontend", "description", "Task 3", "filesLikely",
                                                List.of(), "tests", List.of())));
                workPlan.put("commands", Map.of());
                workPlan.put("definitionOfDone", List.of());
        ...
        void execute_enhancesWorkPlanWithMissingFields() throws Exception {
                ...
                workPlan.put("tasks", List.of(
                                Map.of("id", "task-1", "area", "backend", "description", "Task 1", "filesLikely",
                                                List.of(), "tests", List.of()),
                                Map.of("id", "task-2", "area", "frontend", "description", "Task 2", "filesLikely",
                                                List.of(), "tests", List.of()),
                                Map.of("id", "task-3", "area", "docs", "description", "Task 3", "filesLikely",
                                                List.of(), "tests", List.of())));
        ...
        void execute_parsesAgentsMdCommands() throws Exception {
                ...
                when(gitHubApiClient.getRepoContent(eq("owner"), eq("repo"), eq("AGENTS.md")))
                                .thenReturn(Map.of("content",
                                                Base64.getEncoder().encodeToString(agentsMdContent.getBytes())));
        ...
        private void setupGitHubMocks() {
                ...
                Map<String, Object> tree = Map.of(
                                "sha", "tree-sha",
                                "tree", List.of(
                                                Map.of("path", "ai-orchestrator/src/main/java/Service.java", "type",
                                                                "blob"),
                                                Map.of("path", "frontend/src/app.ts", "type", "blob"),
                                                Map.of("path", "pom.xml", "type", "blob"),
                                                Map.of("path", "README.md", "type", "blob"),
                                                Map.of("path", "ai-orchestrator/src/test/java/ServiceTest.java", "type",
                                                                "blob"),
                ...
                lenient().when(gitHubApiClient.getRepoContent(eq("owner"), eq("repo"), eq("AGENTS.md")))
                                .thenReturn(Map.of("content",
                                                Base64.getEncoder().encodeToString(agentsMdContent.getBytes())));
        }
