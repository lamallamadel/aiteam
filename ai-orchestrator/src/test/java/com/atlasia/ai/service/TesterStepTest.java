...
class TesterStepTest {
        ...
        void execute_ciFailsMaxTimes_escalates() throws Exception {
                ...
                assertEquals(2, runEntity.getCiFixCount());
                verify(metrics, times(2)).recordCiFixAttempt();
        }
        ...
        void execute_e2eFailsMaxTimes_escalates() throws Exception {
                ...
                assertEquals(1, runEntity.getE2eFixCount());
                verify(metrics, times(1)).recordE2eFixAttempt();
        }
        ...
        private void setupFailingThenPassingCheckRuns() {
                ...
                lenient().when(gitHubApiClient.getJobLogs(eq("owner"), eq("repo"), eq(1L)))
        ...
        private void setupAlwaysFailingCheckRuns() {
                ...
                lenient().when(gitHubApiClient.getJobLogs(eq("owner"), eq("repo"), eq(2L)))
        ...
        private void setupCiPassingE2eFailingOnce() {
                ...
                lenient().when(gitHubApiClient.listCheckRunsForRef(eq("owner"), eq("repo"), eq("commit-sha")))
        ...
        private void setupCiPassingE2eAlwaysFailing() {
                ...
                lenient().when(gitHubApiClient.listCheckRunsForRef(eq("owner"), eq("repo"), anyString()))
        ...
        private Map<String, Object> createCheckRun(Long id, String name, String status, String conclusion,
                        boolean isE2e) {
