...
public class ArchitectStep implements AgentStep {
    ...
    private ArchitectureAnalysis performLlmAnalysis(RunContext context, String repoContext) {
        try {
            ...
            log.error("LLM architecture analysis failed, using fallback: {}", e.getMessage());
                ...
                "items", Map.of(
                        ...
                        "properties", Map.of(
                                ...
                                Map.of("type", "string", "description",
                                        "Pattern name (e.g., Repository, MVC, Factory)"),
                                "location", Map.of("type", "string", "description", "Where this pattern is used"),
                                "description",
                                Map.of("type", "string", "description", "How the pattern is implemented")),
        ...
        properties.put("recommendedPatterns", Map.of(
                ...
                "items", Map.of(
                        ...
                        "properties", Map.of(
                                ...
                                "implementation",
                                Map.of("type", "string", "description", "How to implement this pattern")),
        ...
        properties.put("architectureDecisions", Map.of(
                ...
                "items", Map.of(
                        ...
                        "properties", Map.of(
                                ...
                                "consequences",
                                Map.of("type", "string", "description", "Expected consequences and tradeoffs")),
    ...
    private ArchitectureAnalysis createFallbackAnalysis(RunContext context) {
        ...
        analysis.setIntegrationPoints(
                Arrays.asList("REST API endpoints", "Database transactions", "Frontend-backend communication"));
    ...
    public static class ArchitectureAnalysis {
        ...
        public List<DesignPattern> getIdentifiedPatterns() {
            return identifiedPatterns;
        }

        public void setIdentifiedPatterns(List<DesignPattern> identifiedPatterns) {
            this.identifiedPatterns = identifiedPatterns;
        }

        public List<RecommendedPattern> getRecommendedPatterns() {
            return recommendedPatterns;
        }

        public void setRecommendedPatterns(List<RecommendedPattern> recommendedPatterns) {
        ...
        public List<ArchitectureDecision> getArchitectureDecisions() {
        ...
        public void setIntegrationPoints(List<String> integrationPoints) {
            this.integrationPoints = integrationPoints;
        }

        public List<TechnicalRisk> getTechnicalRisks() {
            return technicalRisks;
        }

        public void setTechnicalRisks(List<TechnicalRisk> technicalRisks) {
    ...
    public static class TestingStrategy {
        ...
        public String getIntegrationTests() {
